...
static const std::string KINOVA_RSDF_DIR = "@KINOVA_RSDF_DIR@";
static const std::string KINOVA_CONVEX_DIR = "@KINOVA_CONVEX_DIR@";
static const std::string INSTALL_DIR = "@CMAKE_INSTALL_FULL_DATADIR@";
