...
KinovaRobotModule::KinovaRobotModule() : mc_rbdyn::RobotModule(JVRC_DESCRIPTION_PATH, "jvrc1")
{
...
ROBOT_MODULE_DEFAULT_CONSTRUCTOR("KinovaRobotModule", mc_robots::KinovaRobotModule)
